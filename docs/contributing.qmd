...
spaceprime could always use more documentation,
whether as part of the official spaceprime docs,
...
3.  The pull request should work for Python 3.8 and later, and
    for PyPy. Check <https://github.com/connor-french/spaceprime/pull_requests> and make sure that the tests pass for all
