...
[Packages we're loading and why]

The data we're using in this example is a GeoTiff raster file of habitat suitability values for this cute frog, *Phyllomedusa distincta*:  

![](images/pdistincta.jpg)  
