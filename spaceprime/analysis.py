...
def calc_sumstats(
    ...
    """
    Calculates a suite of genetic summary statistics on allele counts matrices generated by [filter_gt][analysis.filter_gt] or otherwise generated through scikit-allel.
    The required input is an allele counts matrix for all individuals/demes, and a dictionary mapping deme IDs to their coordinates, generated by [samples_to_deme_coords][utilities.samples_to_deme_coords].
    ...
    Parameters:
      ...
      coords_dict (dict): A dictionary mapping deme IDs to their coordinates, generated by [samples_to_deme_coords][utilities.samples_to_deme_coords].
      ...
      ac_anc (dict, optional): A dictionary mapping ancestral population IDs to their allel counts matrices. If provided, summary statistics are calculated within ancestral populations and not among them. Defaults to None.
